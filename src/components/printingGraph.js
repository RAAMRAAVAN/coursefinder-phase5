...
return  graph.loading || graph2.loading?(
    ...
    <div>
        ...
        {graphMenu?<button onClick={()=>{hideGraph()}} className="btn btn-primary">Hide Graph</button>:<button onClick={()=>{setGraphMenu(true)}} className="btn btn-primary">Show Graph</button>}
        <div className="mt-3">
